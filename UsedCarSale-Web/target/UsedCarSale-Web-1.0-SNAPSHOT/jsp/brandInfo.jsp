...
<div class="container body">
    <div class="main_container">
        ...
        <div class="right_col" role="main">
                        ...
                        <div class="x_content">
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                <c:forEach items="${carbrandList}" var="carbrand">
                                    <tr data-id="${carbrand.brandId}">
                                        <td>${carbrand.brandName}</td>
                                        <td>
                                            <button data-id="${carbrand.brandId}"
                                                    onclick="editCarBrand('${carbrand.brandId}','${carbrand.brandName}')"
                                                    class="btn btn-info btn-xs">修改
                                            </button>
                                            <button data-id="${carbrand.brandId}"
                                                    data-empId="${emp.empId}"
                                                    onclick="delCarBrand(this)"
                                                    class="btn btn-danger btn-xs deleteClick">删除
                                            </button>
                                        </td>
                                    </tr>
                                </c:forEach>
            ...
            <!-- /page content -->
            <div class="row">
                <%@include file="brandInfoAdd.jsp" %>
                <%@include file="brandInfoEdit.jsp" %>
            </div>
        </div>
        <!-- footer content -->
...
<script>
    function delCarBrand(e) {
        var id = e.getAttribute("data-id");
        var projectName = $('#projectName').attr('project');
        $.getJSON(
            projectName + '/brand/delCarBrand.action',
            {id: id,},
            function (data) {
                if (data) {
                    window.location.reload();
                } else {
                    alert("该品牌下还有车系等信息，请先删除它们再试");
                }
            });
    }

    function editCarBrand(id, name) {
