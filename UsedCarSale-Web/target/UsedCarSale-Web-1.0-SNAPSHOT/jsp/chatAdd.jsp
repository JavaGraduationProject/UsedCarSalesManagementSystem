    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            ...
            <form id="addCustomer" data-parsley-validate class="form-horizontal form-label-left"
                  action="${pageContext.request.contextPath}/chat/insertChat.action" method="post">
                <input type="hidden" name="empId1" value="${emp.empId}">
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="customerName_add">聊天内容
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" id="customerName_add" name="content" required="required"
                               class="form-control col-md-7 col-xs-12">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12">指定人员</span>
                    </label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <select name="empId" id="getName" class="select2_single form-control"
                                tabindex="-1">
