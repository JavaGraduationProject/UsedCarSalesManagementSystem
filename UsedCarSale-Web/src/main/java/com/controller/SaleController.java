...
public class SaleController {
    ...
    public Map<String, List<Employee>> getAllEmpByCompanyId(String companyId) {
        ...
        assist.setRequires(Assist.andEq("employee.positionId", 2));
    ...
    public ModelAndView getAllSale(String empId) {
        ...
        if (positionId.equals(MyConst.ADMINPOSITION)) {
            ...
            modelAndView.setViewName("EmpSaleList");//用户权限
        }
