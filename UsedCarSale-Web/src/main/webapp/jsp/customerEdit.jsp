        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form id="addCustomer" data-parsley-validate class="form-horizontal form-label-left"
                    action="${pageContext.request.contextPath}/customer/updateCustomer.action" method="post">
                    <input type="hidden" name="empId" value="${emp.empId}"/>
                    <input type="hidden" name="companyId" value="${emp.companyId}"/>
                    <input type="hidden" id="customerId_edit" name="customerId" value=""/>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="customerName_edit">客户姓名
                            <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="customerName_edit" name="customerName" required="required"
                                   class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="customerPhone_edit">客户电话
                            <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <p style="margin-bottom: 0px;border-left-width: 0px;padding-left: 130px;padding-top: 5px;">
                            男:
                            <input id="customerSex_editM" type="radio" class="flat" name="customerSex"
                                   value="男" checked="" required />
                            女:
                            <input id="customerSex_editF" type="radio" class="flat" name="customerSex"
                                   value="女" />
                        </p>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group">
                                <div class='input-group date customerBirthday_format'>
                                    <input id='customerBirthday_edit' name="customerBirthday" type='text'
                                           class="form-control" />
